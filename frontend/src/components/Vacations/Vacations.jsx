...
const Vacations = () => {
  ...
  return (
    <div className="p-1.5 animate-fade-in text-text-main font-poppins">
            ...
            <div className="space-y-2 text-xs text-text-muted border-t border-gray-100 pt-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-text-main">
                  {/* CORREGIDO: etiqueta amigable según perfil */}
                  {user?.idUsuario === user?.idResponsableP || user?.idPerfil === 2 ? 'Tú eres el Líder' : 'Responsable del Proyecto'}
                </span>
              </div>
            </div>
          </div>
      ...
      {/* CORREGIDO: El panel ahora evalúa si cumple cualquiera de las dos condiciones de líder */}
      {(user?.idUsuario === user?.idResponsableP || user?.idPerfil === 2) && (
